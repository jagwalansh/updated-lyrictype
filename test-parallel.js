...
async function run() {
  ...
  console.log(`Fetched ${itunesData.results.length} songs from iTunes. Checking lyrics for all in parallel...`);
  ...
  withoutLyrics.forEach(r => console.log(`${r.trackName} - ${r.artistName} (Error: ${r.error || 'none'})`));
}
